...
class AdminAddStoreScreen extends StatefulWidget {
  ...
  @override
  _AdminAddStoreScreenState createState() => _AdminAddStoreScreenState();
}
  ...
  Future<void> _addStore() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('تم حفظ المتجر بنجاح')));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.storeId == null ? 'إضافة متجر' : 'تعديل متجر',
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                onPressed: _addStore,
                child: Text(
                  widget.storeId == null ? 'إضافة' : 'تحديث',
                ),
              ),
            ],
          ),
